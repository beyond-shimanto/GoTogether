...
export const ProfileView = () => {
    ...
    const [profileAverageRating, setProfileAverageRating] = useState(0.0)
    ...
    useEffect(()=>{
        ...
        setProfileAverageRating(avg_review)
    ...
    <div className="profile-view">
        ...
        <div className="row">
            <div className="names-container">
                ...
                {profileIsTrusted && <h2 className='badge'>TRUSTED</h2>}
            </div>
        ...
        <div className="reviews-container">
            <h3>Reviews</h3>
            <h4>average rating: {profileAverageRating}</h4>
